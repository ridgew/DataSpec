...
namespace Gwsoft.EaseMode
{
    ...
    public class GatewayUpdateResponse : ResponseBase
    {
        ...
        public void DoTest()
        {
            ...
            instance.ESP_HttpAddress = new EaseString { ESP_Data = linkDat, ESP_Length = (ushort)linkDat.Length };

            byte[] socketDat = EaseString.DefaultEncoding.GetBytes("10.199.112.14:9010");
            instance.ESP_SocketAddress = new EaseString { ESP_Data = socketDat, ESP_Length = (ushort)socketDat.Length };
