            ...
            get
            {
                if (_EaseDocument4Test == null)
                {
                    ...
                    EaseDocument doc = new EaseDocument
                    {
                        ...
                        ESP_Name = new EaseString { ESP_Data = nameBytes, ESP_Length = (ushort)nameBytes.Length },
                        ESP_URL = new EaseString { ESP_Data = urlBytes, ESP_Length = (ushort)urlBytes.Length },
                        ESP_Version = 0,
                        ESP_Content = new EaseString { ESP_Data = contentBytes, ESP_Length = (ushort)contentBytes.Length }
                    };
